...
const canSubmit = computed(() => {
    return (
        !!form.oldPassword.getInputValue() &&
        !!form.newPassword.getInputValue() &&
        !!form.confirmPassword.getInputValue() &&
...
async function submitForm() {
    ...
    try {
        const { changePasswordAction } = useProfileService(currentUser.value.idUser);
...
<template>
    <div class="change-password-container">
        <form @submit.prevent="submitForm">
            <InputText :control="form.oldPassword" label="Current password" type="password" autocomplete="new-password"/>

            <InputText :control="form.newPassword" label="New password" type="password"/>

            <InputText :control="form.confirmPassword" label="Confirm new password" type="password"/>

            <p v-if="passwordsDoNotMatch" class="form-error">
